...
const UpdateBook = () => {
    ...
    const submit = async () => {
        try {
            if (Data.url === '' || Data.title === '' || Data.author === '' || Data.price === '' || Data.desc === '' || Data.language === '') {
                ...
                const response = await axios.put(`https://book-heaven-bk.onrender.com/api/v1/update-book`, Data, { headers: headers })
    ...
    return (
        <div className='bg-zinc-900 h-[100%] p-0 md:p-4'>
            <h1 className='text-3xl md:text-5xl font-semibold text-zinc-400 mb-8'>Update Book</h1>
            <div className='bg-zinc-800 p-4 rounded'>
                ...
                <button onClick={submit} className='mt-4 w-[15%] bg-blue-500 rounded p-2 text-white font-semibold'>Update Book</button>
            </div>
        </div>
    )
}
